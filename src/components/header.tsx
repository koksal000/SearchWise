...
export function Header({ 
  ...
  return (
    <header className="sticky top-0 z-40 flex flex-col border-b bg-background/80 px-4 pt-2 backdrop-blur-sm md:px-6">
      <Collapsible open={isActionsOpen} onOpenChange={setActionsOpen} className="flex flex-col gap-2">
        ...
        <CollapsibleContent asChild>
          <div className="hidden sm:flex items-center justify-center gap-2 pb-2">
